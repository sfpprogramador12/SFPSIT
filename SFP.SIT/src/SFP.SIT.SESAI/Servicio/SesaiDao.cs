...
>>>>>>> parent of 1d90231... Se agregan los cambios de Mak
            ...
            lstDatos.Add(new SIT_ADM_USUARIO { usrclave = 1283, usrnombre = "Erika Anilu", usrpaterno = "Ortiz", usrmaterno = "García", usrpuesto = "DIRECTORA DE TRANSPARENCIA Y ASESORÍA", usrcontraseña = "eaortiz", usrfecbaja = new DateTime(), usrcorreo = "eaortiz@funcionpublica.gob.mx", usrextension = "Sin Extensión", usrtitulo = "Lic.", usrintentos = 0, usrbloquearfin = new DateTime(), usrdesignacion = " ", usrauxcorreo = " ", usrfecmod = new DateTime(2017, 07, 27), usractivo = ""  });
            lstDatos.Add(new SIT_ADM_USUARIO { usrclave = 1284, usrnombre = "Alejandra", usrpaterno = "Perez", usrmaterno = "Aguilar", usrpuesto = "SUBDIRECTORA DE PROCEDIMIENTOS Y RECURSOS DE ACCESO A INFORMACION", usrcontraseña = "apereza", usrfecbaja = new DateTime(), usrcorreo = "apereza@funcionpublica.gob.mx", usrextension = "Sin Extensión", usrtitulo = "Lic.", usrintentos = 0, usrbloquearfin = new DateTime(), usrdesignacion = " ", usrauxcorreo = " ", usrfecmod = new DateTime(2017, 07, 27), usractivo = ""  });
            lstDatos.Add(new SIT_ADM_USUARIO { usrclave = 1285, usrnombre = "Luz María", usrpaterno = "Martínez", usrmaterno = "Torres", usrpuesto = "JEFE(A) DE DEPARTAMENTO DE TRATAMIENTO DE DATOS PERSONALES", usrcontraseña = "liolvera", usrfecbaja = new DateTime(), usrcorreo = "lmmartinez@funcionpublica.gob.mx", usrextension = "Sin Extensión", usrtitulo = "Lic.", usrintentos = 0, usrbloquearfin = new DateTime(), usrdesignacion = " ", usrauxcorreo = " ", usrfecmod = new DateTime(2017, 07, 27), usractivo = ""  });
