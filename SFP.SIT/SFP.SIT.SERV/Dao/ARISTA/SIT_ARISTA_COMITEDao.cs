...
{
	 public class SIT_ARISTA_COMITEDao : BaseDao
	 {
	 	 public long iSecuencia { get; set; } 	
	 	 public SIT_ARISTA_COMITEDao(DbConnection cn, DbTransaction transaction, String dataAdapter) : base(cn, transaction, dataAdapter)
	 	 {
	 	}
