...
{
	 public class SIT_ARISTA_RESOLUCIONDao : BaseDao
	 {
	 	 public long iSecuencia { get; set; } 	
	 	 public SIT_ARISTA_RESOLUCIONDao(DbConnection cn, DbTransaction transaction, String dataAdapter) : base(cn, transaction, dataAdapter)
	 	 {
	 	}
