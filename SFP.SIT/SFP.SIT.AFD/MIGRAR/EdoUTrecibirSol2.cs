...
namespace SFP.SIT.AFD.MIGRAR
{
    public class EdoUTrecibirSol2 : AfdNodoBase
    {
        ...
        public Object Accion(Object oDatos)
        {
            ...
            ////////    SIT_RED_NODO nodoNvoUTanalizar = ExisteNodo(_afdEdoDataMdl.solClave, Constantes.NodoEstado.UT_RECIBIR_SOLICITUD, (int)segAux.usrclave, _afdEdoDataMdl.ID_Capa + 1);
            ...
            ////////            nedclave = Constantes.NodoEstado.UT_RECIBIR_SOLICITUD,
            ...
            ////////    return Turnar(_afdEdoDataMdl, 0 );
            ////////}
            ////////else if (iArista == Constantes.Respuesta.TURNAR)
            ////////{
